...
char sql_selectMapRecord[] = "SELECT runtimepro, name, steamid, style FROM ck_playertimes a WHERE runtimepro = ( SELECT MIN(runtimepro) FROM ck_playertimes b WHERE b.style = a.style AND mapname='%s' ) AND mapname='%s';";
