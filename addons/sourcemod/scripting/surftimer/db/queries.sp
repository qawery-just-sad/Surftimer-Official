...
// ck_announcements
char sql_createAnnouncements[] = "CREATE TABLE IF NOT EXISTS `ck_announcements` (`id` int(11) NOT NULL AUTO_INCREMENT, `server` varchar(256) NOT NULL DEFAULT 'Beginner', `name` varchar(32) NOT NULL, `mapname` varchar(128) NOT NULL, `mode` int(11) NOT NULL DEFAULT '0', `time` varchar(32) NOT NULL, `group` int(12) NOT NULL DEFAULT '0', `style` int(11) NOT NULL DEFAULT '0', PRIMARY KEY (`id`))DEFAULT CHARSET=utf8mb4;";

// ck_bonus
char sql_createBonus[] = "CREATE TABLE IF NOT EXISTS ck_bonus (steamid VARCHAR(32), name VARCHAR(32), mapname VARCHAR(32), runtime FLOAT NOT NULL DEFAULT '-1.0',`velStartXY` int(11) NOT NULL,`velStartXYZ` int(11) NOT NULL,`velStartZ` int(11) NOT NULL,`velEndXY` int(11) NOT NULL,`velEndXYZ` int(11) NOT NULL,`velEndZ` int(11) NOT NULL, zonegroup INT(12) NOT NULL DEFAULT 1, style INT(11) NOT NULL DEFAULT 0, PRIMARY KEY(steamid, mapname, zonegroup, style)) DEFAULT CHARSET=utf8mb4;";
...
// ck_checkpoints
char sql_createCheckpoints[] = "CREATE TABLE `ck_checkpoints` (`steamid` VARCHAR(32) NOT NULL,`mapname` VARCHAR(32) NOT NULL,`cp` int(11) NOT NULL,`time` float NOT NULL,`velStartXY` int(11) NOT NULL,`velStartXYZ` int(11) NOT NULL,`velStartZ` int(11) NOT NULL,`zonegroup` int(12) NOT NULL,PRIMARY KEY (`steamid`,`mapname`,`cp`,`zonegroup`)) DEFAULT CHARSET=utf8mb4";
...
// ck_playeroptions2
char sql_createPlayerOptions[] = "CREATE TABLE IF NOT EXISTS `ck_playeroptions2` (`steamid` varchar(32) NOT NULL DEFAULT '', `timer` tinyint(11) NOT NULL DEFAULT '1', `hide` tinyint(11) NOT NULL DEFAULT '0', `sounds` tinyint(11) NOT NULL DEFAULT '1', `chat` tinyint(11) NOT NULL DEFAULT '0', `viewmodel` tinyint(11) NOT NULL DEFAULT '1', `autobhop` tinyint(11) NOT NULL DEFAULT '1', `checkpoints` tinyint(11) NOT NULL DEFAULT '1', `gradient` tinyint(11) NOT NULL DEFAULT '3', `speedmode` tinyint(11) NOT NULL DEFAULT '0', `centrespeed` tinyint(11) NOT NULL DEFAULT '0', `centrehud` tinyint(11) NOT NULL DEFAULT '1', teleside tinyint(11) NOT NULL DEFAULT '0', `module1c` tinyint(11) NOT NULL DEFAULT '1', `module2c` tinyint(11) NOT NULL DEFAULT '2', `module3c` tinyint(11) NOT NULL DEFAULT '3', `module4c` tinyint(11) NOT NULL DEFAULT '4', `module5c` tinyint(11) NOT NULL DEFAULT '5', `module6c` tinyint(11) NOT NULL DEFAULT '6', `sidehud` tinyint(11) NOT NULL DEFAULT '1', `module1s` tinyint(11) NOT NULL DEFAULT '5', `module2s` tinyint(11) NOT NULL DEFAULT '0', `module3s` tinyint(11) NOT NULL DEFAULT '0', `module4s` tinyint(11) NOT NULL DEFAULT '0', `module5s` tinyint(11) NOT NULL DEFAULT '0', prestrafe tinyint(11) NOT NULL DEFAULT '0', cpmessages tinyint(11) NOT NULL DEFAULT '1', wrcpmessages tinyint(11) NOT NULL DEFAULT '1', smallhud tinyint(11) NOT NULL DEFAULT '1', prespeedstagemsg tinyint(11) NOT NULL DEFAULT '1', PRIMARY KEY (`steamid`)) DEFAULT CHARSET=utf8mb4;";
...
char sql_updatePlayerOptions[] = "UPDATE ck_playeroptions2 SET timer = %i, hide = %i, sounds = %i, chat = %i, viewmodel = %i, autobhop = %i, checkpoints = %i, gradient = %i, speedmode = %i, centrespeed = %i, centrehud = %i, teleside = %i, module1c = %i, module2c = %i, module3c = %i, module4c = %i, module5c = %i, module6c = %i, sidehud = %i, module1s = %i, module2s = %i, module3s = %i, module4s = %i, module5s = %i, prestrafe = %i, cpmessages = %i, wrcpmessages = %i, smallhud = %i, prespeedstagemsg = %i where steamid = '%s'";
...
// ck_playertimes
char sql_createPlayertimes[] = "CREATE TABLE IF NOT EXISTS ck_playertimes (steamid VARCHAR(32), mapname VARCHAR(32), name VARCHAR(32), runtimepro FLOAT NOT NULL DEFAULT '-1.0', velStartXY INT(11) NOT NULL DEFAULT '0', velStartXYZ INT(11) NOT NULL DEFAULT '0', velStartZ INT(11) NOT NULL DEFAULT '0', velEndXY INT(11) NOT NULL DEFAULT '0', velEndXYZ INT(11) NOT NULL DEFAULT '0', velEndZ INT(11) NOT NULL DEFAULT '0', style INT(11) NOT NULL DEFAULT '0', PRIMARY KEY(steamid, mapname, style)) DEFAULT CHARSET=utf8mb4;";
...
char sql_createVipAdmins[] = "CREATE TABLE IF NOT EXISTS `ck_vipadmins` (`steamid` varchar(32) NOT NULL DEFAULT '', `title` varchar(128) DEFAULT '0', `namecolour` int(11) DEFAULT '0', `textcolour` int(11) NOT NULL DEFAULT '0', `joinmsg` varchar(255) DEFAULT 'none', `pbsound` varchar(256) NOT NULL DEFAULT 'none', `topsound` varchar(256) NOT NULL DEFAULT 'none', `wrsound` varchar(256) NOT NULL DEFAULT 'none', `inuse` int(11) DEFAULT '0', `vip` int(11) DEFAULT '0', `admin` int(11) NOT NULL DEFAULT '0', `zoner` int(11) NOT NULL DEFAULT '0', `active` int(11) NOT NULL DEFAULT '1', PRIMARY KEY (`steamid`), KEY `vip` (`steamid`,`vip`,`admin`,`zoner`)) DEFAULT CHARSET=utf8mb4;";

// ck_wrcps
char sql_createWrcps[] = "CREATE TABLE IF NOT EXISTS `ck_wrcps` (`steamid` varchar(32) NOT NULL DEFAULT '', `name` varchar(32) DEFAULT NULL, `mapname` varchar(32) NOT NULL DEFAULT '', `runtimepro` float NOT NULL DEFAULT -1, `velStartXY` int(11) NOT NULL, `velStartXYZ` int(11) NOT NULL, `velStartZ` int(11) NOT NULL, `stage` int(11) NOT NULL, `style` int(11) NOT NULL DEFAULT 0, PRIMARY KEY (`steamid`,`mapname`,`stage`,`style`), KEY `stagerank` (`mapname`,`runtimepro`,`stage`,`style`)) DEFAULT CHARSET=utf8mb4;";
